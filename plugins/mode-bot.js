...
let totalf = Object.values(global.plugins).filter(
 ...
 await conn.sendButton(m.chat, `*Hallo Semua*
Saya 𝙍𝙖𝙢𝙙𝙖𝙣𝘽𝙊𝙏 𝙑𝟮.𝟬 Jika Kalian Perlu Bantuan Silahkan Chat Owner Nyaa
Kalau Ada Yg Error Bisa Langsung Report Ke Owner.\n`,wm + '\n\n' + botdate, thumbdoc, [['Aʟʟ Mᴇɴᴜ','.? all'],['Lɪsᴛ Mᴇɴᴜ','.siuuu']], m, {
contextInfo: { externalAdReply :{
                        mediaUrl: '',
                        mediaType: 2,
                        description: 'anu',
                        title: `𝙍𝙖𝙢𝙙𝙖𝙣𝘽𝙊𝙏 𝙑𝟮.𝟬 : ${ohari} Hari ${ojam} Jam ${onet} Menit ${detek} Detik`,
